...
**Complete Windows Setup Guide with Examples:**
- 📖 **[WINDOWS_QUICKSTART.md](WINDOWS_QUICKSTART.md)** - Get running in 5 minutes (TL;DR version)
- 📖 **[WINDOWS_INSTALLATION_GUIDE.md](WINDOWS_INSTALLATION_GUIDE.md)** - Detailed step-by-step with troubleshooting & demo code

**Path**:
1. Python 3.9+ → Virtual Environment → Dependencies  
2. Configure `.env` with API keys  
3. Launch Backend (Terminal 1) & Frontend (Terminal 2)  
4. Access UI at http://localhost:8501  

Total time: ~10 minutes setup + 30 seconds to launch next time  
