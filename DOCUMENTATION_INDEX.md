...
| **WINDOWS_INSTALLATION_GUIDE.md** | Complete Windows setup & demos | 25 min |
| **QDRANT_SETUP_GUIDE.md** | Vector database configuration | 15 min |
...
#### 🚀 "I want to install and run on Windows"
→ **WINDOWS_INSTALLATION_GUIDE.md** (Complete step-by-step setup with demos)

#### 📊 "I want to setup vector search capabilities"
→ **QDRANT_SETUP_GUIDE.md** (Qdrant vector database setup)
